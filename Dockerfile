...
FROM ghcr.io/mysociety/data_common:sha-114f4e6
...
RUN mkdir /setup/src/test_repo \
    && touch /setup/src/test_repo/__init__.py \
    ...
    && echo "/workspaces/test_repo/src/" > /usr/local/lib/python3.10/site-packages/test_repo.pth \
    && echo "/workspaces/test_repo/src/data_common/src" > /usr/local/lib/python3.10/site-packages/data_common.pth
